    ...
    value: function render() {
      ...
      for (var i = start; i < end; i++) {
        ...
        buttons.push(_react2.default.createElement(
          'li',
          { key: i, className: ['page-item',isCurrent ?'active' : null].join(' ')},
          _react2.default.createElement(
            'a',
            { role: 'button', className:'page-link', href: '#', onClick: btnEvent, tabIndex: '0' },
            _react2.default.createElement(
              'span',
              null,
              i + 1
      ...
      buttons = [_react2.default.createElement(
        'li',
        { key: 'first', className: [!isNotFirst ? 'disabled' : null,'page-item'].join(' ') },
        _react2.default.createElement(
          'a',
          {
            role: 'button',
        ...
        'li',
        { key: 'prev', className:[!isNotFirst ? 'disabled' : null,'page-item'].join(' ') },
        _react2.default.createElement(
          'a',
          {
            role: 'button',
      ...
      buttons = buttons.concat([_react2.default.createElement(
        'li',
        { key: 'next', className: [!isNotLast ? 'disabled' : null,'page-item'].join(' ') },
        _react2.default.createElement(
          'a',
          {
            role: 'button',
        ...
        'li',
        { key: 'last', className: [!isNotLast ? 'disabled' : null,'page-item'].join(' ') },
        _react2.default.createElement(
          'a',
          {
            role: 'button',
